...
scaling_eta_ELY   = eta_ELY_nominal / eta_ELY_max_model
...
# UP  =  {'PV': 0,'BAT': 0,'ELY': 0,'C': 0, 'TANK': 0,'FC': 0,'HP': 0, 'HEX': 0}
...
P_ElyOn   = m.addVars(nHours, lb=0, ub=S_ELY_max, name="P_ElyOn")              # S_ELY*ElyOn
...
for t in range(nHours):
    ...
    m.addConstr(P_ElyOn[t] >= S_ELY - S_ELY_max * (1 - ElyOn[t]), "PowerEly4")
