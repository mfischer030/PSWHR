...
function [error_val, slope_data, fit_y] = breakpoint_eval_fun(breakpoints, input, output, floating_breakpoint)
    ...
    % First half of breakpoint guess is the x values
    x_vals = breakpoints(1:length(breakpoints)/2);
    
    % Second half of the breakpoint guess is the y values
